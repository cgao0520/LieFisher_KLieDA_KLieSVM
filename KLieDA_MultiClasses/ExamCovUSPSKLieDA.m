function ExamCovUSPSKLieDA(iter_n, trn1, trn2, train_n, tst1, tst2, test_n, dim,w,h)
...
for i=1:iter_n
    ...
    acc(1,i) = aa;
    [aa, a, km1, km2, covCell] = KLieDA(trn1,trn2,train_n,tst1,tst2,test_n,dim,w,h,'polym');
    acc(2,i) = aa;
...
l1=sprintf('rbf: %0.2f%%',accy(1)*100);
l2=sprintf('poly: %0.2f%%',accy(2)*100);
l3=sprintf('linear: %0.2f%%',accy(3)*100);
l4=sprintf('tanh: %0.2f%%',accy(4)*100);
l5=sprintf('sig: %0.2f%%',accy(5)*100);
